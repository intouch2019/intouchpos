                                                ...
                                                <li class="submenu">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li class="submenu submenu-two"><a href="javascript:void(0);" class="active subdrop">SMS<span class="menu-arrow inside-submenu"></span></a>
                                                            <ul>
                                                                <li><a href="sms-settings.php" class="active">SMS Settings</a></li>
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="w-100 d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <img src="assets/img/icons/sms-icon-01.svg" alt="Img">
                                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 d-flex">
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="w-100 d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <img src="assets/img/icons/sms-icon-02.svg" alt="Img">
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 d-flex">
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="w-100 d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <img src="assets/img/icons/sms-icon-03.svg" alt="Img">
                                                    </div>
                                                    <div class="d-flex align-items-center">
