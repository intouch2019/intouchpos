			...
			<div class="row">
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<img src="assets/img/avatar/avatar-1.jpg" class="avatar-xxl avatar bd-placeholder-img rounded" alt="img">
							<img src="assets/img/avatar/avatar-2.jpg" class="avatar-xxl avatar  d-placeholder-img rounded-top" alt="img">
							<img src="assets/img/avatar/avatar-3.jpg" class="avatar-xxl avatar bd-placeholder-img rounded-end" alt="img">
							<img src="assets/img/avatar/avatar-7.jpg" class="avatar-xxl avatar bd-placeholder-img rounded-bottom" alt="img">
							<img src="assets/img/avatar/avatar-4.jpg" class="avatar-xxl avatar bd-placeholder-img rounded-start" alt="img">
							<img src="assets/img/avatar/avatar-5.jpg" class="avatar-xxl avatar bd-placeholder-img rounded-circle" alt="img">
							<img src="assets/img/avatar/avatar-6.jpg" class="avatar-xxl avatar bd-placeholder-img  rounded-pill" alt="img">
						</div>
					</div>
				</div>
				<!-- /Borders Radius -->
				...
				<div class="col-xl-6">
					<div class="card">
						...
						<div class="card-body">
							<img src="assets/img/avatar/avatar-1.jpg" class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-0" alt="img">
							<img src="assets/img/avatar/avatar-2.jpg" class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-1" alt="img">
							<img src="assets/img/avatar/avatar-3.jpg" class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-2" alt="img">
							<img src="assets/img/avatar/avatar-4.jpg" class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-3" alt="img">
							<img src="assets/img/avatar/avatar-5.jpg" class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-4" alt="img">
							<img src="assets/img/avatar/avatar-6.jpg" class="avatar-xxl avatar bd-placeholder-img bd-placeholder-img rounded-5" alt="img">
						</div>
					</div>
				</div>
				<!-- /Sizes -->
