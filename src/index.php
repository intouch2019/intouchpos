					...
					<div class="card revenue-widget flex-fill">
						<div class="card-body">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<a href="profit-and-loss.php" class="text-decoration-underline fs-13 fw-medium">View All</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xl-3 col-sm-6 col-12 d-flex">
					<div class="card revenue-widget flex-fill">
						<div class="card-body">
							...
							<div class="d-flex align-items-center justify-content-between">
								<p class="mb-0"><span class="fs-13 fw-bold text-success">+35%</span> vs Last Month</p>
								<a href="invoice-report.php" class="text-decoration-underline fs-13 fw-medium">View All</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card revenue-widget flex-fill">
						<div class="card-body">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<a href="expense-list.php" class="text-decoration-underline fs-13 fw-medium">View All</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card revenue-widget flex-fill">
						<div class="card-body">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<a href="sales-report.php" class="text-decoration-underline fs-13 fw-medium">View All</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-xxl-4 col-md-6 d-flex">
					<div class="card flex-fill">
						<div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
							...
							<a href="low-stocks.php" class="fs-13 fw-medium text-decoration-underline">View All</a>
						</div>
						<div class="card-body">
				...
				<div class="col-xl-6 col-sm-12 col-12 d-flex">
					<div class="card flex-fill">
						<div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
							...
							<a href="online-orders.php" class="fs-13 fw-medium text-decoration-underline">View All</a>
						</div>
				...
				<div class="col-xxl-4 col-md-6 d-flex">
					<div class="card flex-fill">
						<div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
							...
							<a href="customers.php" class="fs-13 fw-medium text-decoration-underline">View All</a>
						</div>
						<div class="card-body">
