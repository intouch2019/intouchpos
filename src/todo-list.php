        ...
        <div class="content">
            <div class="page-header">
                ...
                <ul class="table-top-head">
                    <li>
                        <a href="todo.php" class="todo-grid-view"><i data-feather="grid" class="feather-rotate-ccw"></i></a>
                    </li>
                    <li>
                        <a href="todo-list.php" class="todo-list-view active"><i data-feather="list" class="feather-rotate-ccw"></i></a>
                    </li>
                    <li>
