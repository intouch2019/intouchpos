				...
				<ul class="table-top-head">
					<li>
						<div class="d-flex me-2 pe-2 border-end">
							<a href="employees-list.php" class="btn-list me-2"><i data-feather="list" class="feather-user"></i></a>
							<a href="employees-grid.php" class="btn-grid active bg-primary me-2"><i data-feather="grid" class="feather-user text-white"></i></a>
						</div>
					</li>
					<li class="me-2">
						...
						<div class="card">
							<div class="card-body">
								<div class="d-flex align-items-start justify-content-between mb-2">
									...
									<div>
										<a href="employee-details.php" class="avatar avatar-xl avatar-rounded border p-1 rounded-circle">
									...
									<div class="dropdown">
										...
										<ul class="dropdown-menu dropdown-menu-end ">
											<li>
												<a href="edit-employee.php" class="dropdown-item"><i data-feather="edit" class="me-2"></i>Edit</a>
											</li>
											<li>
