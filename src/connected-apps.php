											...
											<ul>
												<li class="submenu">
													...
													<ul>
														...
														<li><a href="connected-apps.php" class="active">Connected Apps</a></li>
													</ul>
												</li>
												<li class="submenu">
										...
										<div class="card">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="app-icon">
														<img src="assets/img/icons/app-icon-01.svg" alt="Img">
													</div>
									...
									<div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="app-icon">
														<img src="assets/img/icons/app-icon-02.svg" alt="Img">
													</div>
													<div class="connect-btn">
														<a href="javascript:void(0);" class="badge bg-outline-success">Connected</a>
													</div>
									...
									<div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="app-icon">
														<img src="assets/img/icons/app-icon-03.svg" alt="Img">
													</div>
													<div class="connect-btn">
														<a href="javascript:void(0);" class="badge bg-outline-success">Connected</a>
													</div>
									...
									<div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="app-icon">
														<img src="assets/img/icons/app-icon-04.svg" alt="Img">
													</div>
													<div class="connect-btn">
														<a href="javascript:void(0);" class="badge bg-outline-success">Connected</a>
													</div>
									...
									<div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="app-icon">
														<img src="assets/img/icons/app-icon-05.svg" alt="Img">
													</div>
													<div class="connect-btn">
														<a href="javascript:void(0);" class="badge bg-outline-success">Connected</a>
													</div>
									...
									<div class="col-xl-4 col-lg-6 col-md-4 col-sm-6">
										<div class="card">
											<div class="card-body">
												<div class="d-flex align-items-center justify-content-between mb-3">
													<div class="app-icon">
														<img src="assets/img/icons/app-icon-06.svg" alt="Img">
													</div>
													<div class="connect-btn">
														<a href="javascript:void(0);" class="badge bg-outline-success">Connected</a>
													</div>
