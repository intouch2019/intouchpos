				...
				<ul class="table-top-head">
					<li>
						<div class="d-flex me-2 pe-2 border-end">
							<a href="department-list.php" class="btn-list me-2"><i data-feather="list" class="feather-user"></i></a>
							<a href="department-grid.php" class="btn-grid active bg-primary me-2"><i data-feather="grid" class="feather-user text-white"></i></a>
						</div>
					</li>
					<li class="me-2">
