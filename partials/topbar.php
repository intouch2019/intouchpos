		...
		<div class="main-header">
			...
			<div class="header-left active">
				<a href="index.php" class="logo logo-normal">
					<img src="assets/img/TTK_PRESTIGE_LTD_LOGO_Jpeg3.jpeg" alt="Img">
				</a>
			...
			<ul class="nav user-menu">
				...
				<li class="nav-item pos-nav">
					<a href="pos.php" class="btn btn-dark btn-md d-inline-flex align-items-center">
				...
				<li class="nav-item dropdown nav-item-box">
					...
					<div class="dropdown-menu notifications">
						...
						<div class="topnav-dropdown-footer d-flex align-items-center gap-3">
							...
							<a href="activities.php" class="btn btn-primary btn-md w-100">View all</a>
						</div>
					</div>
				</li>
				<!-- /Notifications -->
				...
				<li class="nav-item dropdown has-arrow main-drop profile-nav">
					...
					<div class="dropdown-menu menu-drop-user">
						...
						<hr class="my-2">
						<a class="dropdown-item logout pb-0" href="../auth/logout.php"><i class="ti ti-logout me-2"></i>Logout</a>
					</div>
				</li>
			</ul>
			<!-- /Header Menu -->
...
<?php  if ($page === 'pos-2.php' || $page === 'pos-3.php' || $page === 'pos-4.php' || $page === 'pos-5.php' || $page === 'pos.php'){?>
	...
	<div class="header pos-header">
		...
		<ul class="nav user-menu">
			...
			<li class="nav-item pos-nav">
				<a href="index.php" class="btn btn-purple btn-md d-inline-flex align-items-center">
			...
			<li class="nav-item nav-item-box" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="POS Settings">
				<a href="pos-settings.php"><i class="ti ti-settings"></i></a>
			</li>
			<li class="nav-item dropdown has-arrow main-drop profile-nav">
				<a href="javascript:void(0);" class="nav-link userset" data-bs-toggle="dropdown">
					<span class="user-info p-0">
