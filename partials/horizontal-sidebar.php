...
<?php }?>
		<div id="sidebar-menu-3" class="sidebar-menu">
			<div class="main-menu">
				<ul class="nav-menu">
					<li class="submenu">
						<a href="index.php" class="<?php echo ($page =='index.php' || $page == '/' || $page == 'admin-dashboard.php'|| $page == 'sales-dashboard.php' || $page =='dashboard.php' ||$page == 'companies.php' ||$page == 'subscription.php' ||$page =='packages.php' ||$page =='domain.php' ||$page =='purchase-transaction.php' || $page =='chat.php'||$page == 'audio-call.php'||$page == 'call-history.php'||$page =='video-call.php'||$page =='calendar.php'||$page =='contacts.php'||$page =='email.php' || $page =='email-reply.php' ||$page =='todo.php' || $page =='todo-list.php' ||$page =='notes.php'||$page == 'file-manager.php'||$page == 'projects.php'||$page == 'products.php'||$page == 'orders.php'||$page == 'customers.php'||$page == 'cart.php'||$page =='checkout.php'||$page =='wishlist.php'||$page =='reviews.php'||$page =='social-feed.php'||$page =='search-list.php' || $page =='layout-horizontal.php' || $page == 'layout-detached.php' || $page == 'layout-two-column.php' || $page == 'layout-hovered.php' || $page == 'layout-boxed.php' || $page == 'layout-rtl.php' || $page == 'layout-dark.php') ? 'active subdrop' : '' ;?>"><i class="ti ti-layout-grid fs-16 me-2"></i><span> Main Menu</span> <span class="menu-arrow"></span></a>
						<ul>
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='index.php' || $page == '/' || $page == 'admin-dashboard.php'|| $page == 'sales-dashboard.php') ? 'active subdrop' : '' ;?>"><span>Dashboard</span> <span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='dashboard.php' ||$page == 'companies.php' ||$page == 'subscription.php' ||$page =='packages.php' ||$page =='domain.php' ||$page =='purchase-transaction.php') ? 'active subdrop' : '' ;?> "><span>Super Admin</span><span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='chat.php'||$page == 'audio-call.php'||$page == 'call-history.php'||$page =='video-call.php'||$page =='calendar.php'||$page =='contacts.php'||$page =='email.php' || $page =='email-reply.php' ||$page =='todo.php' || $page =='todo-list.php' ||$page =='notes.php'||$page == 'file-manager.php'||$page == 'projects.php'||$page == 'products.php'||$page == 'orders.php'||$page == 'customers.php'||$page == 'cart.php'||$page =='checkout.php'||$page =='wishlist.php'||$page =='reviews.php'||$page =='social-feed.php'||$page =='search-list.php') ? 'active subdrop' : '' ;?> "><span>Application</span><span class="menu-arrow"></span></a>
								<ul>
									...
									<li class="submenu submenu-two"><a href="javascript:void(0);" class="<?php echo ($page =='video-call.php' || $page == 'call-history.php' || $page == 'audio-call.php') ? 'active subdrop' : '' ;?>">Call<span class="menu-arrow inside-submenu"></span></a>
										<ul>
											...
											<li><a href="audio-call.php" class="<?php echo ($page =='audio-call') ? 'active' : '' ;?>">Audio Call</a></li>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='layout-horizontal.php' || $page == 'layout-detached.php' || $page == 'layout-two-column.php' || $page == 'layout-hovered.php' || $page == 'layout-boxed.php' || $page == 'layout-rtl.php' || $page == 'layout-dark.php') ? 'active subdrop' : '' ;?>"><span>Layouts</span><span class="menu-arrow inside-submenu"></span></a>
								<ul>
					...
					<li class="submenu">
						<a href="javascript:void(0);" class="<?php echo ($page =='product-list.php' || $page =='edit-product.php' || $page =='product-details.php' || $page == 'add-product.php' || $page == 'expired-products.php' || $page == 'low-stocks.php' || $page == 'category-list.php' || $page == 'sub-categories.php' || $page == 'brand-list.php' || $page == 'varriant-attributes.php' || $page == 'units.php' || $page == 'warranty.php' || $page == 'barcode.php' || $page == 'qrcode.php') ? 'active subdrop' : '' ;?>"><i class="ti ti-brand-unity fs-16 me-2"></i></i><span> Inventory
							</span> <span class="menu-arrow"></span></a>
						<ul>
							<li><a href="product-list.php" class="<?php echo ($page =='product-list.php' || $page =='product-details.php' || $page =='edit-product.php') ? 'active' : '' ;?>">Products</a></li>
							<li><a href="add-product.php" class="<?php echo ($page =='add-product.php') ? 'active' : '' ;?>">Create Product</a></li>
							<li><a href="expired-products.php" class="<?php echo ($page =='expired-products.php') ? 'active' : '' ;?>">Expired Products</a></li>
							<li><a href="low-stocks.php" class="<?php echo ($page =='low-stocks.php') ? 'active' : '' ;?>">Low Stocks</a></li>
							<li><a href="category-list.php" class="<?php echo ($page =='category-list.php') ? 'active' : '' ;?>">Category</a></li>
							<li><a href="sub-categories.php" class="<?php echo ($page =='sub-categories.php') ? 'active' : '' ;?>">Sub Category</a></li>
							<li><a href="brand-list.php" class="<?php echo ($page =='brand-list.php') ? 'active' : '' ;?>">Brands</a></li>
							<li><a href="units.php" class="<?php echo ($page =='units.php') ? 'active' : '' ;?>">Units</a></li>
							<li><a href="varriant-attributes.php" class="<?php echo ($page =='varriant-attributes.php') ? 'active' : '' ;?>">Variant Attributes</a></li>
							<li><a href="warranty.php" class="<?php echo ($page =='warranty.php') ? 'active' : '' ;?>">Warranties</a></li>
							<li><a href="barcode.php" class="<?php echo ($page =='barcode.php') ? 'active' : '' ;?>">Print Barcode</a></li>
							<li><a href="qrcode.php" class="<?php echo ($page =='qrcode.php') ? 'active' : '' ;?>">Print QR Code</a></li>
						</ul>
					</li>
					<li class="submenu">
						<a href="javascript:void(0);" class="<?php echo ($page =='manage-stocks.php' || $page == 'stock-adjustment.php' || $page == 'stock-transfer.php' || $page =='online-orders.php' || $page == 'pos-orders.php' || $page == 'invoice.php' || $page =='invoice-details.php' || $page =='invoice-details.php' || $page == 'sales-returns.php' || $page == 'quotation-list.php' || $page =='pos.php' || $page == 'pos-2.php' || $page == 'pos-3.php' || $page == 'pos-4.php' || $page == 'pos-5.php' || $page =='coupons.php' || $page == 'gift-cards.php' || $page =='discount-plan.php' || $page == 'discount.php'
							|| $page =='purchase-list.php' || $page == 'purchase-order-report.php' || $page == 'purchase-returns.php' || $page =='expense-list.php' || $page == 'expense-category.php' || $page =='income.php' || $page == 'income-category.php' || $page =='account-list.php' || $page =='money-transfer.php' || $page =='balance-sheet.php'  || $page =='balance-sheet-v2.php' || $page =='trial-balance.php' || $page =='cash-flow.php'  || $page =='cash-flow-v2.php' || $page =='account-statement.php' ) ? 'active subdrop' : '' ;?>"><i class="ti ti-layout-grid fs-16 me-2"></i><span>Sales &amp; Purchase</span> <span class="menu-arrow"></span></a>
						<ul>
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='manage-stocks.php' || $page == 'stock-adjustment.php' || $page == 'stock-transfer.php') ? 'active subdrop' : '' ;?>"><span>Stock</span><span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='online-orders.php' || $page == 'pos-orders.php' || $page == 'invoice.php' || $page =='invoice-details.php' || $page == 'sales-returns.php' || $page == 'quotation-list.php' || $page =='pos.php' || $page == 'pos-2.php' || $page == 'pos-3.php' || $page == 'pos-4.php' || $page == 'pos-5.php') ? 'active subdrop' : '' ;?>"><span>Sales</span><span class="menu-arrow"></span></a>
								<ul>
									<li class="submenu">
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='coupons.php' || $page == 'gift-cards.php' || $page =='discount-plan.php' || $page == 'discount.php') ? 'active subdrop' : '' ;?>"><span>Promo</span><span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='purchase-list.php' || $page == 'purchase-order-report.php' || $page == 'purchase-returns.php') ? 'active subdrop' : '' ;?>"><span>Purchase</span><span class="menu-arrow"></span></a>
								<ul>
					...
					<li class="submenu">
						<a href="javascript:void(0);" class="<?php echo ($page =='ui-alerts.php' || $page == 'ui-accordion.php' || $page == 'ui-avatar.php' || $page == 'ui-badges.php' || $page == 'ui-borders.php' || $page == 'ui-buttons.php' || $page == 'ui-buttons-group.php' || $page == 'ui-breadcrumb.php' || $page == 'ui-cards.php' || $page == 'ui-carousel.php' || $page == 'ui-colors.php' || $page == 'ui-dropdowns.php' || $page == 'ui-grid.php' || $page == 'ui-images.php' || $page == 'ui-lightbox.php' || $page == 'ui-media.php' || $page == 'ui-modals.php'
								...
								|| $page =='tables-basic.php' || $page == 'data-tables.php' || $page =='maps-vector.php' || $page == 'maps-leaflet.php') ? 'active subdrop' : '' ;?>"><i class="ti ti-users-group fs-16 me-2"></i><span>UI Interface</span> <span class="menu-arrow"></span></a>
						<ul>																
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='ui-alerts.php' || $page == 'ui-accordion.php' || $page == 'ui-avatar.php' || $page == 'ui-badges.php' || $page == 'ui-borders.php' || $page == 'ui-buttons.php' || $page == 'ui-buttons-group.php' || $page == 'ui-breadcrumb.php' || $page == 'ui-cards.php' || $page == 'ui-carousel.php' || $page == 'ui-colors.php' || $page == 'ui-dropdowns.php' || $page == 'ui-grid.php' || $page == 'ui-images.php' || $page == 'ui-lightbox.php' || $page == 'ui-media.php' || $page == 'ui-modals.php'
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='icon-fontawesome.php' || $page == 'icon-feather.php' || $page == 'icon-ionic.php' || $page == 'icon-material.php' || $page == 'icon-pe7.php' || $page == 'icon-simpleline.php' || $page == 'icon-themify.php' || $page == 'icon-weather.php' || $page == 'icon-typicon.php' || $page == 'icon-flag.php' || $page == 'icon-tabler.php' || $page == 'icon-bootstrap.php' || $page == 'icon-remix.php') ? 'active subdrop' : '' ;?>"><span>Icons</span><span class="menu-arrow"></span></a>
								<ul>
					...
					<li class="submenu">
						...
						<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='pages.php' || $page =='all-blog.php' || $page == 'blog-details.php' || $page == 'blog-tag.php' || $page == 'blog-categories.php' || $page == 'blog-comments.php' || $page =='countries.php' || $page == 'states.php' || $page == 'cities.php' || $page == 'testimonials.php' || $page == 'faq.php') ? 'active subdrop' : '' ;?>"><span>Content</span><span class="menu-arrow"></span></a>
								<ul>
									<li class="submenu">
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='employees-grid.php' || $page =='add-employee.php' || $page =='edit-employee.php' || $page =='employee-details.php' || $page =='employees-list.php' || $page == 'department-grid.php' || $page == 'designation.php' || $page == 'shift.php'  || $page =='department-list.php') ? 'active subdrop' : '' ;?>"><span>Employees</span><span class="menu-arrow"></span></a>
								<ul>
					...
					<li class="submenu">
						<a href="javascript:void(0);"  class="<?php echo ( $page == 'billers.php' || $page == 'suppliers.php' || $page == 'store-list.php' || $page == 'warehouse.php' || $page =='users.php' || $page == 'roles-permissions.php' || $page =='permissions.php' || $page == 'delete-account.php' ) ? 'active subdrop' : '' ;?>"><i class="ti ti-circle-plus fs-16 me-2"></i><span>More</span><span class="menu-arrow"></span></a>
						<ul>
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ( $page == 'billers.php' || $page == 'suppliers.php' || $page == 'store-list.php' || $page == 'warehouse.php') ? 'active subdrop' : '' ;?>"><span>People</span><span class="menu-arrow"></span></a>
								<ul>
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="<?php echo ($page =='users.php' || $page == 'roles-permissions.php' || $page =='permissions.php' || $page == 'delete-account.php') ? 'active subdrop' : '' ;?>"><span>User Management</span><span class="menu-arrow"></span></a>
								<ul>
